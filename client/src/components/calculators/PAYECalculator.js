...
class PayeComponent extends Component {
  ...
  handleSubmit = e => {
	...
	let paye = taxable.KE.PAYE({basic_pay: parseFloat(basic), benefits:parseFloat(benefits), insurance_relief:parseFloat(relief) });
      ...
      <div className="bg-gray-200">
		...
		<section class="pattern-dots-xl text-gray-300 body-font">
          <div class="container px-5 py-12 mx-auto flex flex-wrap">
            <h2 class="sm:text-4xl text-3xl text-gray-900 font-bold title-font mb-2 md:w-1/5">PAYE</h2>
            <div class="md:w-4/5 md:pl-6 text-gray-700">
				...
				{this.state.calculated && (
					...
					<section class="text-gray-700 body-font">
						...
						<div class="container py-3 mx-auto flex">
							<div class="lg:w-8/12 md:w-8/12 bg-white rounded-lg p-8 flex flex-col w-full md:ml-auto md:mr-auto mt-10 md:mt-0 relative z-10  shadow-md">
								<center>
									PAYE = <span className="font-medium">{this.state.paye}</span>										
								</center>
							</div>
						</div>
