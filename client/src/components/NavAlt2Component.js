        ...
        <div className='container mx-auto flex flex-wrap p-2 flex-row md:flex-row items-center justify-between'>
          ...
          >
            ...
            <div className='relative'>
              <button
                className='flex rounded-lg py-4 md:py-4 px-4 text-black bg-transparent hover:text-grey-700 focus:outline-none font-medium hover:text-luminous-blue'
                type='button'
                value='Pricing'
            ...
            <button
              className='flex rounded-lg py-4 md:py-2 px-4 mr-4 text-black bg-transparent hover:text-grey-700 focus:outline-none font-medium hover:text-luminous-blue'
              type='button'
              value='Help'
              onClick={help}
            >
            ...
            {/*<a className="flex mr-5 md:ml-0 ml-4 font-medium hover:text-luminous-blue cursor-pointer">
              Batch Slips
