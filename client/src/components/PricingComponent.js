      ...
      <div class="p-4 xl:w-1/2 md:w-1/2 w-full">
        <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden bg-white">
          ...
          <h1 class="text-5xl text-gray-900 leading-none flex items-center pb-4 mb-4 border-b border-gray-200">
            <span><span class="text-lg ml-1 font-normal text-gray-500">from</span> KES 2000</span>
          ...
          <p class="text-xs text-gray-500 mt-3">Contact Us for more information on Pricing.</p>
