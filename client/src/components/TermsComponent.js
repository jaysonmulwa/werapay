				...
				<div class="container px-5 py-12 mx-auto flex flex-wrap">
						...
						<div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
							<div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
								...
								<p class="leading-relaxed">
									...
									materials (information or software) on WeraPay's web site for
									...
									contained on WeraPay's web site;
									<br />
									...
									of these restrictions and may be terminated by WeraPay at any
					...
					<div class="flex relative pt-10 pb-10 sm:items-center md:w-2/3 mx-auto">
						...
						<div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
							<div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
								...
								<p class="leading-relaxed">
									The materials on WeraPay's web site are provided "as is".
									WeraPay makes no warranties, expressed or implied, and hereby
									disclaims and negates all other warranties, including without
									limitation, implied warranties or conditions of
									merchantability, fitness for a particular purpose, or
									non-infringement of intellectual property or other violation
									of rights. Further, WeraPay does not warrant or make any
					...
					<div class="flex relative pt-10 pb-10 sm:items-center md:w-2/3 mx-auto">
						...
						<div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
							<div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
								...
								<p class="leading-relaxed">
									In no event shall WeraPay or its suppliers be liable for any
									damages (including, without limitation, damages for loss of
									data or profit, or due to business interruption,) arising out
									of the use or inability to use the materials on WeraPay's
									Internet site, even if WeraPay or an authorized representative
					...
					<div class="flex relative pt-10 pb-10 sm:items-center md:w-2/3 mx-auto">
						...
						<div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
							<div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
								...
								<p class="leading-relaxed">
									The materials appearing on WeraPay's web site could include
									technical, typographical, or photographic errors. WeraPay does
									not warrant that any of the materials on its web site are
									accurate, complete, or current. WeraPay may make changes to
									the materials contained on its web site at any time without
									notice. WeraPay does not, however, make any commitment to
					...
					<div class="flex relative pt-10 pb-10 sm:items-center md:w-2/3 mx-auto">
						...
						<div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
							<div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
								...
								<p class="leading-relaxed">
									WeraPay has not reviewed all of the sites linked to its
									...
									endorsement by WeraPay of the site. Use of any such linked web
					...
					<div class="flex relative pt-10 pb-10 sm:items-center md:w-2/3 mx-auto">
						...
						<div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
							<div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
								...
								<p class="leading-relaxed">
									WeraPay may revise these terms of use for its web site at any
					...
					<div class="flex relative pt-10 pb-10 sm:items-center md:w-2/3 mx-auto">
						...
						<div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
							<div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
								<h2 class="font-medium title-font text-gray-900 mb-1 text-xl">
									8. WeraPay Trademarks and Logos Policy
								</h2>
								<p class="leading-relaxed">
									All uses of the WeraPay logo, WeraPay badges, brand slogans,
									iconography, and the like, may only be used with express
									permission from WeraPay. WeraPay reserves all rights, even if
									certain assets are included in WeraPay open source projects.
					...
					<div class="flex relative pt-10 pb-10 sm:items-center md:w-2/3 mx-auto">
						...
						<div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
							<div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
								...
								<p class="leading-relaxed">
									WeraPay has the right to maintain a list of reserved names
									...
									other reason (or no reason). Additionally, WeraPay reserves
									the right to change any already-claimed name at its sole
									discretion. In such cases, WeraPay will make reasonable effort
					...
					<div class="flex relative pt-10 pb-10 sm:items-center md:w-2/3 mx-auto">
						...
						<div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
							<div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
								...
								<p class="leading-relaxed">
									Any claim relating to WeraPay's web site shall be governed by
