        ...
        <FormGroup>
          <Fade in={true} out={true} tag='h5' className='mt-3'>
            <div className='flex flex-col md:flex-row -mx-3'>
              <div className='w-12/12 lg:w-5/12 px-3'>
                <input
                  className='bg-white rounded border border-gray-400 text-base px-4 py-2 mb-4 focus:outline-none focus:shadow-outline w-full'
                  type='text'
                  name='paycode'
                  id='paycode'
                  placeholder='Item'
              ...
              <div className='w-12/12 md:w-5/12 px-3'>
                <input
                  className='bg-white rounded border border-gray-400 text-base px-4 py-2 mb-4 focus:outline-none focus:shadow-outline w-full'
                  type='number'
                  name='amount'
              ...
              <div className='w-1/12 md:w-2/12 px-3'>
                <button
                  className='rounded-lg py-2 px-4 text-luminous-red bg-gray-100 hover:bg-luminous-red hover:text-white focus:outline-none'
                  type='button'
                  color='danger'
                  value='remove'
      ...
      <div className='bg-gray-200'>
        ...
        <section className='body-font'>
          <div className='container py-6 mx-auto flex'>
            <div className='lg:w-8/12 md:w-8/12 bg-white rounded-lg p-8 flex flex-col w-full md:ml-auto md:mr-auto mt-10 md:mt-0 relative z-10  shadow-md'>
              <h2 className='text-gray-900 text-lg mb-1 font-medium title-font mb-5'>
                Earnings
              </h2>
              ...
              <div className='mb-2 mr-2'>
                <button
                  className='rounded-lg py-2 px-4 text-white bg-gray-600 hover:bg-luminous-green focus:outline-none'
                  value='add more'
        ...
        <section className='text-gray-700 body-font'>
          <div className='container py-6 mx-auto flex'>
            <div className='lg:w-8/12 md:w-8/12 bg-white rounded-lg p-8 flex flex-col w-full md:ml-auto md:mr-auto mt-10 md:mt-0 relative z-10  shadow-md'>
              ...
              <input
                className='bg-white rounded border border-gray-400 text-base px-4 py-2 mb-4 focus:outline-none focus:shadow-outline'
                type='text'
                name='cname'
                id='cname'
                placeholder=''
              ...
              />
              <label
                className='block text-gray-700 text-sm font-medium mb-4'
                for='companyaddress'
              >
                Company Logo
              </label>
            ...
            <div className='lg:w-8/12 md:w-8/12 bg-white rounded-lg p-8 flex flex-col w-full md:ml-auto md:mr-auto mt-10 md:mt-0 relative z-10  shadow-md'>
              <form onSubmit={this.handleSubmit}>
                <center>
                  ...
                  <div className='mb-2 mr-2'>
                    <button
                      className='rounded-lg py-2 px-4 text-white bg-luminous-blue hover:bg-blue-600 focus:outline-none'
                      value='add more'
                      type='submit'
                    >
                      Submit
              ...
              <div className='container py-6 mx-auto flex'>
                <div className='lg:w-8/12 md:w-8/12 bg-white rounded-lg p-8 flex flex-col w-full md:ml-auto md:mr-auto mt-10 md:mt-0 relative z-10  shadow-md'>
                  <center>
                    ...
                    or
                    <button
                      className='rounded-lg mx-3 py-2 px-4 text-blue-600 bg-gray-100 hover:bg-luminous-blue hover:text-white focus:outline-none'
                      type='button'
                      value='Send as Mail'
              ...
              <div className='container py-6 mx-auto flex'>
                <div className='lg:w-8/12 md:w-8/12 bg-white rounded-lg p-8 flex flex-col w-full md:ml-auto md:mr-auto mt-10 md:mt-0 relative z-10  shadow-md'>
                  <div className='flex flex-col md:flex-row -mx-3'>
                    ...
                    <div className='w-1/12 md:w-3/12 px-3'>
                      <button
                        className='rounded-lg mx-3 py-2 px-4 text-white bg-luminous-blue hover:bg-blue-600 focus:outline-none'
                        type='button'
                        value='Send as Mail'
